---
layout: post
title: "一个脚本搞定 Claude Code 模型管理与切换"
date: 2026-05-12 21:12:41 +0800
categories: [AI, 工具, Claude]
tags: [Claude Code, Claude Launcher, 模型管理, AI 编程]
description: 介绍 Claude Launcher，一个用于一键切换 Claude Code 模型的终端工具，支持预设管理、项目级配置和交互式菜单。
---
