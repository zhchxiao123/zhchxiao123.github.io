---
title: "岗位最佳实践手册：从“知道如何验证正确”到“设计一种更容易正确的工作方式”"
layout: documentation
project_id: ai-dev-methodology
permalink: /docs/ai-dev-methodology/03-best-practices/
...
AI 可以辅助代码审计、日志分析、生成安全检查清单、解释漏洞。但**安全判断不可外包**——它依赖上下文、攻击者视角和系统思维。
