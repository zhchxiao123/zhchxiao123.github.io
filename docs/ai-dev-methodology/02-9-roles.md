---
title: "9 岗位完整版：从写代码到驾驭生成—验证系统"
layout: documentation
project_id: ai-dev-methodology
permalink: /docs/ai-dev-methodology/02-9-roles/
...
这是「AI 时代程序员方法论」专题的第二篇 — **9 岗位完整版（做什么）**。建议按顺序阅读：

1. ➡️ [思考手册](/docs/ai-dev-methodology/01-thinking-handbook/)：从“怎么让 AI 写出来”到“我凭什么知道它写对了”——核心是驾驭生成—验证回路（先读这篇建立心智）。
2. ✅ **9 岗位完整版（本文）**：把方法论展开到 9 个岗位，回答每个岗位的**核心正确性、验证信号、AI 委托边界、新护城河**。
3. ➡️ [岗位最佳实践手册](/docs/ai-dev-methodology/03-best-practices/)：把方法论落到**操作**——9 个岗位的常见问题、错误做法、最佳实践、通用场景 SOP，让“正确更容易发生”。